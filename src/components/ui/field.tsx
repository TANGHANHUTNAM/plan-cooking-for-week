...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-left text-sm/6 leading-normal font-normal text-muted-foreground group-has-data-horizontal/field:text-balance [[data-variant=legend]+&]:-mt-1.5",
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn("text-sm/6 font-normal text-destructive", className)}
      {...props}
    >
      {content}
    </div>
