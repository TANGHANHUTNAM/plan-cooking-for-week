...
function DrawerTitle({
  ...
  return (
    <DrawerPrimitive.Title
      ...
      className={cn(
        "font-heading text-lg font-semibold tracking-[-0.01em] text-foreground",
        className
      )}
      {...props}
    />
